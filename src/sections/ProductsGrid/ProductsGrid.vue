...
import { type Product, ProductList, ProductPreview } from '@/domain/Product';

import { AddProductToCartAction } from '@/capabilities/AddProductToCartAction';
import { ProductFilters, ProductFiltersModel } from '@/capabilities/ProductFilters';
import { ProductLikeAction } from '@/capabilities/ProductLikeAction';

import { ProductsGridFilterBar } from '@/sections/ProductsGrid';
