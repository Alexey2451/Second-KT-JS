...
// migrate imports to new aliases; UI and logic unchanged
import { useUnit } from 'effector-vue/composition';

import { normalNumberFormat } from '@/common/lib';

import { getProductByIdQuery, type Product, ProductModel } from '@/domain/Product';
